...
## Corpus Check
- 57 files · ~43,090 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 316 nodes · 489 edges · 24 communities (14 shown, 10 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6d6ee4c3`
...
8. `QuestionsPage()` - 7 edges
9. `TOPIC_LABELS` - 7 edges
10. `Progress` - 7 edges
...
Cohesion: 0.11
Nodes (26): QuestionFilters(), GlossaryText(), HIGHLIGHT_OPTIONS, MarkdownComponents, MarkdownContent(), RehypePlugins, PersonalExample(), pickAnswer() (+18 more)
...
Cohesion: 0.12
Nodes (15): Auto-glossary implementation, Mock implementation, Not done (out of React-only scope), Notes, Notes, Notes, Phase 1 — Foundation ✅ COMPLETE, Phase 2 — Core reading experience ✅ COMPLETE (+7 more)
...
Cohesion: 0.35
Nodes (9): listQuestions(), parseLevel(), parseQuery(), parseTopic(), QuestionFilters, parseLanguage(), QuestionsPage(), SearchParams (+1 more)
...
## Knowledge Gaps
- **164 isolated node(s):** `eslintConfig`, `nextConfig`, `config`, `DETAILS`, `DETAILS` (+159 more)
...
- **Why does `createServerSupabaseClient()` connect `Community 4` to `Community 1`, `Community 2`, `Community 6`, `Community 7`?**
