# Graph Report - Interview_Prep_App  (2026-05-22)

## Corpus Check
- 57 files · ~43,390 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 318 nodes · 491 edges · 23 communities (13 shown, 10 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a3a5ec53`
...
2. `cn()` - 14 edges
3. `createServerSupabaseClient()` - 11 edges
4. `main()` - 10 edges
5. `listTerms()` - 10 edges
6. `Topic` - 9 edges
7. `requireEnv()` - 8 edges
8. `Progress` - 8 edges
...
Cohesion: 0.13
Nodes (27): QuestionFilters(), TooltipDemo(), GlossaryPage(), SECTION_ORDER, generateMetadata(), Params, QuestionDetailPage(), SearchParams (+19 more)

### Community 3 - "Community 3"
Cohesion: 0.14
Nodes (20): GlossaryText(), HIGHLIGHT_OPTIONS, MarkdownComponents, MarkdownContent(), RehypePlugins, PersonalExample(), pickAnswer(), QuestionCard() (+12 more)
...
Cohesion: 0.14
Nodes (10): { handlers, signIn, signOut, auth }, readRole(), Role, Session, requireEnv(), metadata, config, proxy() (+2 more)

### Community 6 - "Community 6"
Cohesion: 0.11
Nodes (17): Auto-glossary implementation, Mock implementation, Next.js question bank expansion ✅ COMPLETE, Not done (out of React-only scope), Notes, Notes, Notes, Notes (+9 more)
...
## Knowledge Gaps
- **165 isolated node(s):** `eslintConfig`, `nextConfig`, `config`, `DETAILS`, `DETAILS` (+160 more)
...
- **Why does `requireEnv()` connect `Community 5` to `Community 2`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `createServerSupabaseClient()` connect `Community 2` to `Community 1`, `Community 5`?**
