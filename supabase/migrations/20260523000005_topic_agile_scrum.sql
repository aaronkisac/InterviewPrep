-- Add agile-scrum to allowed topics for questions and terms tables.
...
alter table public.questions
  ...
  check (topic in ('react', 'typescript', 'nextjs', 'javascript', 'redux', 'html5', 'css', 'react-hooks', 'git', 'agile-scrum'));
