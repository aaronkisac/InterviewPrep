...
export const i18nCourse = {
  en: {
    ...
    courseComplete: "Course complete — replay any lesson to keep it fresh.",
    coursesSubtitle: "Guided paths that teach each topic from zero to interview-ready.",
    coursesTitle: "Learn",
    correct: "Correct!",
    ...
    lessonsDone: (done: number, total: number) => `${done}/${total} lessons`,
    locked: "Locked",
    nextLesson: "Next lesson",
    noCourses: "No courses yet — check back soon.",
    notQuite: "Not quite",
  ...
  tr: {
    ...
    courseComplete: "Kurs tamamlandı — taze tutmak için istediğin dersi tekrar oyna.",
    coursesSubtitle: "Her konuyu sıfırdan mülakata hazır seviyeye öğreten rehberli yollar.",
    coursesTitle: "Öğren",
    correct: "Doğru!",
    ...
    lessonsDone: (done: number, total: number) => `${done}/${total} ders`,
    locked: "Kilitli",
    nextLesson: "Sonraki ders",
    noCourses: "Henüz kurs yok — yakında.",
    notQuite: "Tam değil",
    pool: "Sırayla eklemek için dokun",
    replay: "Tekrar oynat",
    sectionAdvanced: "İleri",
    sectionCore: "Çekirdek",
    sectionFoundations: "Temeller",
    sectionInterview: "Mülakat",
    signInToStart: "Başlamak için giriş yap",
    start: "Başla",
